  ...
  return (
    <section id="products" className="py-12 md:py-20 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-bold text-blue-900 text-center mb-8 md:mb-12">Nuestros Productos</h2>
          ...
          {products.map((product, index) => (
            <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-4 md:p-6">
                ...
                <p className="text-blue-700 text-sm md:text-base">{product.description}</p>
              </div>
            </div>
          ))}
        </div>
        <div className="mt-8 md:mt-12 text-center">
          <a
            href="#contact"
            className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-full text-lg transition duration-300 inline-block w-full md:w-auto"
          >
